...
export default function Admin() {
  ...
  const stats = [
    { label: 'Pending', count: pendingCount, icon: Clock, color: 'text-warning' },
    { label: 'Approved', count: approvedCount, icon: CheckCircle, color: 'text-success' },
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4 animate-slide-up" style={{ animationDelay: '300ms' }}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="font-display text-lg font-semibold">Booking Requests</h2>
            </div>
          ...
          <div className="space-y-4 animate-slide-up" style={{ animationDelay: '400ms' }}>
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-display text-lg font-semibold">Calendar Overview</h2>
            </div>
            <BookingCalendar
