...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gray-600/10 flex flex-col">
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-xl mx-auto">
              Professional studio booking made effortless. Reserve your perfect
              session in seconds and focus on what matters most – your art.
            </p>
      ...
      <footer className="border-t border-border py-6 bg-card/50">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          © 2026 DG StudioBooker. Built for creators.
        </div>
      </footer>
    </div>
  );
